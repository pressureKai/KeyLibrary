...
public class StateView extends View {
    ...
    public View getEmptyView() {
        if (mEmptyView == null) {
            mEmptyView = inflate(mEmptyResource, RETRY);
        }
        return mEmptyView;
    }
    ...
    public StateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEmptyResource == 0) {
            mEmptyResource = R.layout.layout_empty_view;
        }
        if (mRetryResource == 0) {
            mRetryResource = R.layout.layout_empty_view;
        }
    ...
    public View showRetry() {
        ...
        mRetryView.setOnClickListener(v -> {
            if (mRetryClickListener != null) {
                showLoading();
                mRetryView.postDelayed(() -> mRetryClickListener.onRetryClick(), 400);
            }
        });
    ...
    private View inflate(View view, @ViewType int viewType) {
        final ViewParent viewParent = getParent();
    ...
    public void setRetryView(View retryView) {
        ...
        inflate(retryView, RETRY);
    }

    public void setEmptyView(View emptyView) {
        this.mEmptyView = emptyView;
        inflate(emptyView, EMPTY);
    }
